...
fn main() {
    ...
    cc::Build::new()
        ...
        .file("src/cuda/c_raymarcher.cpp")
        .file("src/cuda/c_raymarcher_kernel.cu")
        .flag("-std=c++17")
        .flag("--expt-relaxed-constexpr")
        .flag("-w")
        .compile("c_raymarcher");

    // Specify dependencies
    println!("cargo:rerun-if-changed=src/cuda/c_raymarcher.cpp");
    println!("cargo:rerun-if-changed=src/cuda/c_raymarcher_kernel.cu");
}